:py:mod:`sqlalchemy_omnisci.base`
=================================

.. py:module:: sqlalchemy_omnisci.base
...
.. autoapisummary::
   ...
   sqlalchemy_omnisci.base.ARRAY
   sqlalchemy_omnisci.base.Boolean
   sqlalchemy_omnisci.base.BOOLEAN
   sqlalchemy_omnisci.base.OmniSciIdentifierPreparer
   sqlalchemy_omnisci.base.OmniSciCompiler
   sqlalchemy_omnisci.base.OmniSciExecutionContext
   sqlalchemy_omnisci.base.OmniSciDDLCompiler
   sqlalchemy_omnisci.base.OmniSciTypeCompiler
   sqlalchemy_omnisci.base.OmniSciDialect
...
.. autoapisummary::
   ...
   sqlalchemy_omnisci.base.RESERVED_WORDS
   sqlalchemy_omnisci.base.ischema_names
   sqlalchemy_omnisci.base.AUTOCOMMIT_REGEXP
   sqlalchemy_omnisci.base.COMPOUND_KEYWORDS
   sqlalchemy_omnisci.base.colspecs
   sqlalchemy_omnisci.base.dialect
   sqlalchemy_omnisci.base.construct_arguments
...
.. py:class:: OmniSciIdentifierPreparer(dialect, **kw)
...
.. py:class:: OmniSciCompiler(dialect, statement, cache_key=None, column_keys=None, for_executemany=False, linting=NO_LINTING, **kwargs)
...
.. py:class:: OmniSciExecutionContext
...
.. py:class:: OmniSciDDLCompiler(dialect, statement, schema_translate_map=None, render_schema_translate=False, compile_kwargs=util.immutabledict())
...
.. py:class:: OmniSciTypeCompiler(dialect)
...
.. py:class:: OmniSciDialect(pool=NullPool, **kwargs)
